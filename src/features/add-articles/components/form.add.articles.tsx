...
const RichTextEditor = dynamic(
  () => import("@/features/add-articles/components/rich.text.editor"),
  { ssr: false },
);

export function FormAddArticles() {
  const {
    form,
    preview,
    handleUploadClick,
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
        ...
        <div className="flex flex-col space-y-2">
          ...
          {form.formState.errors.root?.content && (
            <p className="text-sm text-red-500">
              {form.formState.errors.root.content.message}
            </p>
          )}
        </div>
